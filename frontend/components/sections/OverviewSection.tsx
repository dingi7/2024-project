        ...
        <div className="container px-4 md:px-6">
          <div className="flex flex-col items-center justify-center space-y-4 text-center">
            <div className="space-y-2">
              ...
              <p className="max-w-[900px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                Our programming contest offers a thrilling platform for coders
                of all levels to showcase their skills, compete against the
                best, and win amazing prizes.
              </p>
            </div>
          </div>
          <div className="mx-auto grid max-w-5xl items-start gap-6 py-12 lg:grid-cols-3 lg:gap-12">
            ...
            <div className="grid gap-1">
              ...
              <p className="text-muted-foreground">
                Tackle a variety of coding challenges that test your
            ...
            <div className="grid gap-1">
              ...
              <p className="text-muted-foreground">
                Track your progress and see how you stack up against the
                competition.
              </p>
            </div>
          </div>
